...
interface BucharestBlobProps {
  className?: string
  size?: "sm" | "md" | "lg"
}

export function BucharestBlob({ className, size = "lg" }: BucharestBlobProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image
            src="/images/arc-de-triumf-bucuresti.webp"
            alt="Arcul de Triumf București - simbol al capitalei"
            fill
      ...
      {config.showDetails && (
        <>
          ...
          >
            ...
            >
              <div className="flex items-center gap-1.5 px-3 py-2 border-b border-border/30 bg-muted/30">
                ...
                <span className="ml-2 text-[8px] text-muted-foreground truncate">site-bucuresti.ro</span>
              </div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-2 mb-2 pb-2 border-b border-white/10">
                ...
                <span className="text-muted-foreground text-[9px]">bucuresti.tsx</span>
              </div>
              <div className="text-purple-400">
                {"const"} <span className="text-cyan-400">website</span> = {"{"}
              </div>
              <div className="pl-3 text-foreground/80">
                city: <span className="text-green-400">"București"</span>,
              </div>
              <div className="pl-3 text-foreground/80">
                seo: <span className="text-yellow-400">100</span>,
              </div>
              <div className="pl-3 text-foreground/80">
                speed: <span className="text-cyan-400">"blazing"</span>
              </div>
          ...
          >
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-green-500/20 border border-green-500/30 backdrop-blur-sm shadow-lg">
              <div className="w-2.5 h-2.5 rounded-full bg-green-500 animate-pulse" />
              <span className={cn("font-bold text-green-400", size === "lg" ? "text-sm" : "text-xs")}>SEO 100/100</span>
            </div>
          </div>
          ...
          >
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-brand/20 border border-brand/30 backdrop-blur-sm shadow-lg">
              ...
              <span className={cn("font-medium text-brand", size === "lg" ? "text-xs" : "text-[10px]")}>1.2s Load</span>
            </div>
          </div>
