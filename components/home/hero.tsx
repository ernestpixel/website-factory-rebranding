      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 md:pt-32 pb-16 sm:pb-20 relative z-10">
        <div className="max-w-3xl lg:max-w-2xl mx-auto lg:mx-0 text-center lg:text-left">
          ...
          >
            ...
            <Link
              href="/portofoliu"
              className="group flex items-center justify-center gap-3 w-full sm:w-auto px-6 sm:px-8 py-3.5 sm:py-4 rounded-full border border-border/50 hover:border-brand/50 glass-premium transition-all duration-300 hover:glow-subtle"
            >
              <span className="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-brand/10 group-hover:bg-brand/20 transition-colors">
                <Play className="w-3 h-3 sm:w-4 sm:h-4 text-brand ml-0.5" />
              </span>
